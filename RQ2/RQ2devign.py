...
class CodeDataset(Dataset):
    def __init__(self, data, mode='code+comments'):
...
# 创建数据集和数据加载器
mode = 'code+comments'  # 选择输入模式，可以是 'code', 'ast', 'comments', 'code+comments', 'code+ast', 'comments+ast', 'all'
...
# 确保保存目录存在
save_directory = 'model/devign/rq2'
